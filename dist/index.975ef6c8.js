...
var _header = require("./scripts/header");

},{"./sass/main.scss":"dFl68","./scripts/header":"5KFkR"}],"dFl68":[function() {},{}],"5KFkR":[function(require,module,exports) {
...
document.addEventListener("keydown", (evt)=>{
    if (evt.key === "Escape") headerModalMenu.classList.add("invisible");
});
...
document.addEventListener("keydown", (evt)=>{
    if (evt.key === "Escape") headerModalUser.classList.add("invisible");
});
window.addEventListener("click", (evt)=>{
    ...
    if (evt.target === headerUserName) return;
    if (evt.target === headerModalUser) return;
    if (evt.target !== headerModalUser) headerModalUser.classList.add("invisible");
});

},{}]},["icZzK","8lqZg"], "8lqZg", "parcelRequire4785")
